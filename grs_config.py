...
class GrsConfig(object):
    ...
    def __init__(self):
        ...
        xml_file = '/home/anurag/Documents/PhDProject/doris/install/doris_config.xml'
        ...
        self.doris_function_path = self.source_path + "/doris_stack/functions/"
        self.main_code_path = self.source_path + "/doris_stack/main_code/"
        self.paz_function_path = '/home/anurag/Documents/PhDProject/PAZ_codes/'
        # Extend path
